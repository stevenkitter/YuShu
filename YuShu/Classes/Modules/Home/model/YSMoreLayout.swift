...
@objc protocol YSMoreLayoutDataSource : class {
...
class YSMoreLayout: UICollectionViewFlowLayout {
    ...
    // MARK: 对外提供属性
    weak var dataSource : YSMoreLayoutDataSource?
    ...
    fileprivate lazy var colHeights : [CGFloat] = {
        ...
        var colHeights = Array(repeating: headH, count: cols)
        return colHeights
    }()
